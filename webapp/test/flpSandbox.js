		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ABM de Excepciones",
									"targetURL": "#ypfzparamfreegd0-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypfzparamfreegd0-display": {
								"semanticObject": "ypfzparamfreegd0",
								"action": "display",
								"description": "Aplicación para ABM de Excepciones",
								"title": "ABM de Excepciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zparamfreegd0",
									"url": sap.ui.require.toUrl("ypf/zparamfreegd0")
								}
							}
						}
					}
